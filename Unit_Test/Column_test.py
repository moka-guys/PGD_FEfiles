'''
11/8/15
call EvE from within this script
'''
...
class Unit_Test():
    ...
    def Run_EvE(self):
        # command line prompt to call eve for the unit test files
        cmd = "python C:\\Users\\Aled\\workspace\\PGD_FEfiles\\EvE.py C:\\Users\\Aled\\workspace\\EvE\\Unit_Test\\Col_test_input.txt C:\\Users\\Aled\\workspace\\EvE\\Unit_Test\\output"

        # execute the command
        subprocess.call(cmd)

    def check_output(self):
        # where to look for the newly created FE files
        folder = "C:\\Users\\Aled\\workspace\\EvE\\Unit_Test\\output"
